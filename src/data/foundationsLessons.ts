...
export const BOXING_FOUNDATIONS_LEVELS: FoundationLevel[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'boxing-l2-4', discipline: 'boxing', level: 2, order: 4, title: 'Double Jab Cross', techniqueId: 'cc173c23-e32f-4d21-bf85-881cc44d6ff9' },
      { id: 'boxing-l2-5', discipline: 'boxing', level: 2, order: 5, title: 'Lead Uppercut', techniqueId: '7099a55e-20d3-4aad-942a-87a4968bea17' },
