...
export const BOXING_FOUNDATIONS_LEVELS: FoundationLevel[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'boxing-l2-5', discipline: 'boxing', level: 2, order: 4, title: 'Double Jab Cross', techniqueId: 'cc173c23-e32f-4d21-bf85-881cc44d6ff9' },
      { id: 'boxing-l2-6', discipline: 'boxing', level: 2, order: 5, title: 'Parry', techniqueId: '27e05f5b-710e-4869-a4f2-5bd94c5fbcd0' },
      { id: 'boxing-l2-7', discipline: 'boxing', level: 2, order: 6, title: 'Slip', techniqueId: '456730ef-5114-43ba-a3e1-feaa67761719' },
      { id: 'boxing-l2-8', discipline: 'boxing', level: 2, order: 7, title: 'Jab Cross Jab', techniqueId: 'a82e643b-30f5-4f6a-9682-016591d8f188' },
    ],
  },
  {
    level: 3,
