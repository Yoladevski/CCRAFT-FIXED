        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
            ...
            >
              ...
              <h3 className="display-text text-2xl mb-4 text-center">STRUCTURED PROGRESSION</h3>
            ...
            >
              ...
              <h3 className="display-text text-2xl mb-4 text-center">AI ENHANCED INSTRUCTION</h3>
              <p className="text-[#A0A0A0] text-center text-body leading-relaxed">
            ...
            >
              ...
              <h3 className="display-text text-2xl mb-4 text-center">MULTI DISCIPLINE SYSTEM</h3>
              <p className="text-[#A0A0A0] text-center text-body leading-relaxed">
