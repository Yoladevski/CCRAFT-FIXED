    ...
    <div className="fixed inset-0 z-[9999] bg-black flex items-center justify-center p-3 sm:p-4 overflow-hidden">
      <div className="w-full max-w-4xl bg-neutral-900 rounded-lg shadow-2xl border border-red-600/30 max-h-[95vh] sm:max-h-[90vh] flex flex-col">
        <div className="p-3 sm:p-4 md:p-6 border-b border-red-600/30">
          <h1 className="cc-outline-text text-xl sm:text-2xl md:text-3xl font-bold text-red-500 text-center">
        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6 space-y-3 sm:space-y-4 md:space-y-6">
          <div className="prose prose-invert max-w-none">
            <section className="space-y-2 sm:space-y-3">
              <h2 className="cc-outline-text text-base sm:text-lg md:text-xl font-bold text-red-400">ASSUMPTION OF RISK</h2>
            ...
            <section className="space-y-2 sm:space-y-3">
              <h2 className="cc-outline-text text-base sm:text-lg md:text-xl font-bold text-red-400">MEDICAL CLEARANCE</h2>
              <p className="text-xs sm:text-sm md:text-base text-neutral-300 leading-relaxed">
            ...
            <section className="space-y-2 sm:space-y-3">
              <h2 className="cc-outline-text text-base sm:text-lg md:text-xl font-bold text-red-400">RELEASE OF LIABILITY</h2>
              <p className="text-xs sm:text-sm md:text-base text-neutral-300 leading-relaxed">
            ...
            <section className="space-y-2 sm:space-y-3">
              <h2 className="cc-outline-text text-base sm:text-lg md:text-xl font-bold text-red-400">INDEMNIFICATION</h2>
              <p className="text-xs sm:text-sm md:text-base text-neutral-300 leading-relaxed">
            ...
            <section className="space-y-2 sm:space-y-3">
              <h2 className="cc-outline-text text-base sm:text-lg md:text-xl font-bold text-red-400">CONSENT TO TREATMENT</h2>
              <p className="text-xs sm:text-sm md:text-base text-neutral-300 leading-relaxed">
            ...
            <section className="space-y-2 sm:space-y-3">
              <h2 className="cc-outline-text text-base sm:text-lg md:text-xl font-bold text-red-400">ACKNOWLEDGMENT OF UNDERSTANDING</h2>
              <p className="text-xs sm:text-sm md:text-base text-neutral-300 leading-relaxed">
