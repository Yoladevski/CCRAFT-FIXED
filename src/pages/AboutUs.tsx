  ...
  return (
    <div className="min-h-screen bg-[#0E0E0E] py-6 sm:py-16 px-4 sm:px-6 lg:px-8 relative -mt-20 pt-20 sm:pt-24">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div>
          <h2 className="cc-outline-text text-2xl font-bold text-white mb-6">
            LEARN MORE
          </h2>
          <div className="grid gap-6">
            {companyPages.map((page) => (
              ...
              >
                <h3 className="cc-outline-text text-2xl font-bold text-white mb-2 group-hover:text-[#B11226] transition-colors">
                  {page.name}
                </h3>
