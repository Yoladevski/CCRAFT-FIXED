        ...
        <div className="bg-[#1A1A1A] rounded-lg border border-[#2E2E2E] p-6 sm:p-8 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <button
              ...
              className="w-full transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 bg-transparent border-0 p-0 relative"
            >
              <img
                src="https://tjuqljqrsggubbpxcbts.supabase.co/storage/v1/object/public/assets/button-pill.png"
                alt={loading ? 'LOADING...' : isSignUp ? 'CREATE ACCOUNT' : 'SIGN IN'}
          ...
          >
            ...
            />
            <span
              className="absolute inset-0 flex items-center justify-center text-white pointer-events-none gap-2 text-xs sm:text-sm"
              style={{
                fontFamily: 'Redhawk, sans-serif',
                fontWeight: 700,
                textShadow: '-2px -2px 0 #000, 2px -2px 0 #000, -2px 2px 0 #000, 2px 2px 0 #000, 0 0 10px rgba(0, 0, 0, 0.8)',
